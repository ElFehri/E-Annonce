...
@section('createInfo')
<!-- Froala CSS -->
<link href="{{ asset('vendor/froala/css/froala_editor.pkgd.min.css') }}" rel="stylesheet" type="text/css" />

<!-- Froala JS -->
<script src="{{ asset('vendor/froala/js/froala_editor.pkgd.min.js') }}"></script>
